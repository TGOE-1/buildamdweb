...
### github会使用Jekyll作为静态站点生成器，当你的库中有多个md文件时，可能只有主页被正常渲染，其他md仅作为文本文件。如果想让其他md文件也正常渲染，可以按如下方式
...
### 注意，HTML是浏览器唯一能识别和渲染的网页文件格式。你的所有md文件会被转换成html文件，所以代码中使用超链接时，文件后缀的md应改为HTML
